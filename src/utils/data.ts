...
export const productsSeedTreatment = [
  ...
  { "Product Name": "SoyFx Seed Treatment", "Package Size": 120, "Package Units": "fl oz", "Product Packaging": "Jugs", "Product Cost per Package": "$1,099.20", "Product Cost per oz": "$9.16", "Application Rate in Ounces": 1 }
];

export const productsInFurrowFoliar = [
