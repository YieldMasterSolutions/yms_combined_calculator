...
const ResultsDisplay: React.FC<ResultsDisplayProps> = ({
  ...
  const cardClass =
    "mb-8 grid grid-cols-2 gap-4 p-6 rounded-2xl shadow-lg " +
    "bg-gray-100 dark:bg-[#13213c]";
